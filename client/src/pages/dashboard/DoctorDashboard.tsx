...
export default function DoctorDashboard() {
  ...
  const recentTokens = reviewStats?.tokens?.slice(0, 5) || [];
          ...
          <Card data-testid="card-stat-denied">
            ...
            <CardContent>
              {statsLoading ? (
                ...
                <div className="text-2xl font-bold">{reviewStats?.denied || 0}</div>
              )}
            ...
            {statsLoading ? (
                ...
                {recentTokens.map((token: any) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium">Application #{(token.applicationId || "").slice(0, 8)}</p>
                    ...
                    <Badge
                      variant={
                        ...
                        : token.status === "denied" ? "destructive"
                        : "secondary"
                      }
                    >
                      {token.status === "approved" ? "Approved" : token.status === "denied" ? "Denied" : "Pending"}
                    </Badge>
                  </div>
                ))}
              </div>
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground max-w-sm">
                  Review links will be sent to you when applications are ready for your review.
                </p>
              </div>
            )}
          </CardContent>
